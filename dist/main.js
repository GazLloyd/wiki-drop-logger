...
const updateDevCanvases = (prevLootData, prevLootBW, lootData, lootBW) => {
    const cnvbef = getByID('canvas-before'), cnvbefbw = getByID('canvas-before-bw'), cnvaf = getByID('canvas-after'), cnvafbw = getByID('canvas-after-bw');
